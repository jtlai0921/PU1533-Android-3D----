...
public class Texture_Level_Change 
{
	private FloatBuffer mVertexBuffer;//頂點座標資料緩沖
    private FloatBuffer mTextureBuffer;//頂點紋理資料緩沖
    int vCount;
    
    public Texture_Level_Change(float width,float height,float deep)
    {
    	float vertices[]=From2DTo3DUtil.Vertices(width,height,deep);
