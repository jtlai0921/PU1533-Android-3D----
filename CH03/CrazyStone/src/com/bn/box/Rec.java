...
public class Rec extends MyBody{
	...
	GameView gameview;
	int id;
	public Rec(Body body, GameView gameview,float width,float height,int id) {
		super(body, gameview);
		this.height=height;
		this.width=width;
    ...
    {  
        ...
        int id1=gameview.textureId_ding;
        if(id==1)
        {
        	id=gameview.textureId;
        	id1=gameview.textureId;
        }
        else if(id==2)
        {
        	id=gameview.textureId_wall;
        	id1=gameview.textureId_ding;
        }
        else if(id==-1)
        {
        	id=gameview.textureId_diban;//變更的111111111111111111111111111111111111111111111
        	id1=gameview.textureId_ding;
        }
