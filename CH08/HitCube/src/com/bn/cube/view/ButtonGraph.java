...
public class ButtonGraph 
{
    ...
    public ButtonGraph(MyGLSurfaceView mv,float r,float color[])
    {    
    	this.color=color;
    	initVertexData(r);   
    	initShader(mv);
    ...
    public void initShader(MyGLSurfaceView mv)
    {
        ...
        mVertexShader=ShaderUtil.loadFromAssetsFile("vertex_button.sh", mv.getResources());

        mFragmentShader=ShaderUtil.loadFromAssetsFile("frag_button.sh", mv.getResources());  
