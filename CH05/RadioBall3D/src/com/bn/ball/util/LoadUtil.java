...
import com.bn.ball.LoadedObjectVertexNormalTexture;
...
public class LoadUtil 
{
    ...
    (String fname, Resources r,int texId)
    {
    	//載入後物體的參考
		    ...
		    while((temps=br.readLine())!=null) 
		    {
		    	...
		    	String[] tempsa=temps.split("[ ]+");
		      	...
		      	{//此行為紋理座標行
		      		...
		      		//采用青花瓷紋理時的程式碼
		      		alt.add(Float.parseFloat(tempsa[1])*com.bn.ball.Constant.MAX_S_QHC/2.0f);
		      		alt.add(Float.parseFloat(tempsa[2])*com.bn.ball.Constant.MAX_T_QHC/2.0f);
		      		
		      		//采用國畫小品紋理圖時的程式碼
//		      		alt.add(Float.parseFloat(tempsa[1])*MAX_S_GHXP/2.0f);
//		      		alt.add(Float.parseFloat(tempsa[2])*MAX_T_GHXP/2.0f); 
		      	}
