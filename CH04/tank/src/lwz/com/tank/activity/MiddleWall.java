...
public class MiddleWall {
	...
	public MiddleWall(int texId)
	{
		this.texId = texId;
		vCount=36;
		
	//	final int UNIT_SIZE=Constant.Wall_UNIT_SIZE;		
		int rows=middleWallmapdata.length;
...
//        ArrayList<Float> alNormal=new ArrayList<Float>();
        ...
        {
        		float x=middleWallmapdata[i][0]*Wall_UNIT_SIZE;
        		float y=middleWallmapdata[i][1]*Wall_UNIT_SIZE;
        		float z=middleWallmapdata[i][2]*Wall_UNIT_SIZE;
        		float width=middleWallmapdata[i][3]*Wall_UNIT_SIZE;
        		float length=middleWallmapdata[i][4]*Wall_UNIT_SIZE;
        		float height=middleWallmapdata[i][5]*Wall_UNIT_SIZE;
