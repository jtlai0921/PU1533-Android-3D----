...
public class HighWall {
	...
	public HighWall(int texId)
	{
		this.texId = texId;
		vCount=36;
		
	//	final int UNIT_SIZE=Constant.Wall_UNIT_SIZE;		
		int rows=highWallmapdata.length;
...
//        ArrayList<Float> alNormal=new ArrayList<Float>();
        ...
        {
        		float x=highWallmapdata[i][0]*Wall_UNIT_SIZE;
        		float y=highWallmapdata[i][1]*Wall_UNIT_SIZE;
        		float z=highWallmapdata[i][2]*Wall_UNIT_SIZE;
        		float width=highWallmapdata[i][3]*Wall_UNIT_SIZE;
        		float length=highWallmapdata[i][4]*Wall_UNIT_SIZE;
        		float height=highWallmapdata[i][5]*Wall_UNIT_SIZE;
